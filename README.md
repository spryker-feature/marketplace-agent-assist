...
## Optional modules
- [AgentDashboardMerchantPortalGui ^1.3.0](https://github.com/spryker/agent-dashboard-merchant-portal-gui) (MP GUI)
...
- [AgentSecurityMerchantPortalGui ^1.5.0](https://github.com/spryker/agent-security-merchant-portal-gui) (MP GUI)
